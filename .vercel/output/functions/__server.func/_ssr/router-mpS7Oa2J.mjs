...
//#region node_modules/.nitro/vite/services/ssr/assets/router-mpS7Oa2J.js
var router_mpS7Oa2J_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dxjjc1XH.css";
var APP_NAME = "REBASE";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Tres carriles. Adelántalos. Juego de rebasar con niveles."
			},
			{
				name: "theme-color",
				content: "#0c0d10"
...
var $$splitComponentImporter = () => import("./routes-DQY5L1rg.mjs");
...
//#endregion
export { getRouter, router_mpS7Oa2J_exports as t };
